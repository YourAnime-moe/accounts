...
Doorkeeper.configure do
  ...
  #   end
    if current_user
      unless current_user.admin?
        flash[:error] = "You are not permitted to visit this screen."
        redirect_to root_path
      end
    else
      redirect_to root_path
  ...
  #
  access_token_expires_in(Rails.configuration.x.access_token_expires_in)
  ...
  #
  force_ssl_in_redirect_uri !Rails.env.development? && ENV['DISABLE_FORCE_SSL_IN_REDIRECT_URI'].blank?
  #
